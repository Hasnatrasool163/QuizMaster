...
public class CurvesPanel extends GradientPanel {
    ...
    private Timer timer = new Timer(20, (ActionEvent ae) -> {
        repaint();
    });
    ...
    public CurvesPanel() {
        super(new Color(30, 144, 255), Color.decode("#000000"));
...
//        Color end = new Color(255, 255, 255, 0);
        Color start =  new Color(30, 144, 255); // Blue
        Color end = new Color(0xFFFFFF); // White
